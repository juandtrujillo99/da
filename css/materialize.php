...
.teal.lighten-1 {
  background-color: <?php echo $colorMarca;?> !important;
}

.teal-text.text-lighten-1 {
  color: <?php echo $colorMarca;?> !important;
}
...
nav {
  color: <?php echo $colorMarca;?>;
  background-color: <?php echo $colorMarca4;?>;
  width: 100%;
}
...
[type="radio"].with-gap:checked + span:before,
[type="radio"].with-gap:checked + span:after {
  border: 2px solid <?php echo $colorMarca;?>;
}
...
[type="checkbox"]:checked + span:not(.lever):before {
  ...
  border-right: 2px solid <?php echo $colorMarca;?>;
  border-bottom: 2px solid <?php echo $colorMarca;?>;
...
[type="checkbox"].filled-in.tabbed:checked:focus + span:not(.lever):after {
  border-radius: 2px;
  background-color: <?php echo $colorMarca;?>;
  border-color: <?php echo $colorMarca;?>;
}
