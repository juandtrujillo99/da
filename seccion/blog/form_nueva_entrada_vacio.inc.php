...
<div class="row section" id="descripcion-texto">
    ...
    <div class="col-12 row valign-wrapper">
    	...
    	<div class="col-md-10 row">
			...
			<textarea id="texto" name="texto" style="min-height: 30vh;max-height: 40vh;overflow-y: scroll;font-size: .9em;" class="materialize-textarea" data-length="3000" minlength="10" maxlength="3000"></textarea>
