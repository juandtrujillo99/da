...
<div class="row section" id="descripcion-texto">
    ...
    <div class="col-12 row valign-wrapper">
    	...
    	<div class="col-10 row">
			...
			<textarea id="texto" name="texto" style="min-height: 10vh;max-height: 60vh;overflow-y: scroll;" class="materialize-textarea" data-length="1500" minlength="10" maxlength="1500"><?php $validador -> mostrar_texto(); ?></textarea>
				<?php $validador -> mostrar_error_texto(); ?>
