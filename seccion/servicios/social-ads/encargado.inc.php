<div class="d-none d-sm-block section">
	<div class="col-12 row">		
	    <div class="col-12 row" style="padding: 6em 0;">
	    	<div class="col-3"></div>
		    <div class="col-6" align="center">
		        <h2 class="texto2Black">Si necesitas a un profesional para montar tus anuncios en la web este es el lugar indicado.</h2>
		        <br><br>
		...
		<div class="col-10 row" align="center">
			<div class="col-6 row">
				<div class="col-12 row" style="background-color: #000;color: white;position: relative;margin-right: 1em;">
					<div class="col-2"></div>
			...
			<div class="col-6 row">
				<div class="col-12 row" style="background-color: #000;color: white;position: relative; margin-left: 1em;">
					<div class="col-2"></div>
					<div class="col-8 row" style="padding: 2em 0;">
