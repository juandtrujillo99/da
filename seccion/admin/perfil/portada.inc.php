<div class="row">
    ...
    <div class="col-12 col-md-4 row" align="center">
        ...
        <div id="actualizar" class="modal bottom-sheet col-12 col-md-12" style="height:35vh">    
            ...
            <div style="padding: 3em 0;">
                <p class="texto2Black" style="font-size: 1.3em;text-transform: uppercase;">Configuración de tu foto de perfil</p>
            </div>
            <div>
    ...
    if(file_exists(DIRECTORIO_RAIZ."/assets/fotos-perfil/admin/".$admin->obtener_nombre())) {
                    ...
                    <div class="col-12 col-md-6" style="background-color:black;padding: 2em 0;">
                        <br>
                        <a target="_blank" class="btn btn-secundario" href="<?php echo SERVIDOR.'/assets/fotos-perfil/admin/'.$admin->obtener_nombre(); ?>" data-lightbox="Foto de perfil" data-title="Foto de perfil">Ver foto</a>
                        <input class="btn btn-secundario" type="submit" value="Eliminar" name="borrar"><br>
                    </div>
        ...
        <a class="modal-trigger col-12 col-md-4" href="#actualizar">
            <div align="center">   
                <div class="img-profile bg-cover circle" style="background-color: black;margin-top: -5em;background-image:url(<?php echo SERVIDOR.'/assets/fotos-perfil/admin/'.$admin->obtener_nombre(); ?>);"></div>
            </div>
        </a>
        <div class="d-none d-sm-block col-md-4"></div>
