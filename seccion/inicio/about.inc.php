<div class="d-none d-sm-block service1" id="about">
	...
	<div class="col-12 row">
		<div class="col-2"></div>
		<div class="col-8 row">
			<div class="col-11 row bordeadoRojo anime-3">
				<div class="col-7" style="padding: 4.5em 8em;">
			        <h6 class="texto2Black" style="font-size: 1.3em;">¿Quién soy?</h6>
			        <br>
			...
			<div class="col-11 row bordeadoRojo anime-4">
				...
				<div class="col-7" style="padding: 3.8em 8em;">
			        ...
			        <br>
			        <p style="font-size: 1em;">Desde hace más de 6 años vengo preparándome con diferentes proyectos que me han permitido perfeccionar mis habilidades.</p>
			    </div>
			</div>
		</div>
	</div>
	...
	<div class="col-12 row">
		...
		<div class="col-10 row">
			...
			<div class="col-9 row about1 anime-1a">
				...
				<div class="col-1"></div>
				<div class="col-5 row bordeadoRojo">
					<div class="col-12 div1">
				        <h6 class="texto2Black" style="font-size: 1.3em;">¿Por qué deberías contactarme?</h6>
				        <br>
				        <p style="font-size: 1em;">Porque creo que los colores, las formas, el orden y los calendarios pueden ayudar a cualquiera a crecer y ser los mejores en su campo. </p>
				        <br><br><br><br><br>
				    </div>
				</div>
				<div class="col-1"></div>
				<div class="col-5 row bordeadoRojo">
					<div class="col-12 div1">
				        <h6 class="texto2Black" style="font-size: 1.3em;">¿Y además de eso?</h6>
				        <br>
				        <p style="font-size: 1em;">Con mucho esfuerzo y dedicación, me pondré manos a la obra para conseguir mi objetivo <b>"Hacer que tu marca sea irresistiblemente atractiva para el público"</b>.</p>
				        <br><br>
				    </div>
				</div>
				<div class="col-1"></div>
...
<div class="d-block d-sm-none" id="about-m">
	<div class="col-12 row">
