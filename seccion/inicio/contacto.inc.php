<div class="" id="contacto">
	<div class="col-12 row ">
		<div class="col-md-6 section d-none d-sm-block" style="background-image: url(<?php echo RUTA_IMG_OPTIMIZADA;?>31.webp);background-position: center center;background-size: cover;"></div>
		<div class="col-md-6 contact1 row valign-wrapper">
			<div class="col-md-2 col-1"></div>
			<div class="col-md-6 col-10 div1 anime-1a">
				<h5 style="font-size: 4em;" class="textoBlack">Contacto</h5>
				<h6 class="texto2Black">Teléfono</h6>
				<a href="<?php echo $whatsappEmpresa;?>" target="_blank"><p itemprop="telephone"><span class="material-icons">phone</span> +34 <?php echo $telefono2Empresa;?></p></a>
