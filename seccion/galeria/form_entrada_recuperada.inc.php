			...
			<?php
				...
				<div class="row" style="padding: 1em 0;">
					...
					<div class="col-md-12 col-3">				
						...
						<img src="<?php echo RUTA_GALERIA_COVER.$entrada_recuperada -> obtener_imagen();?>" class="imagen d-block d-sm-none">
						<img src="<?php echo RUTA_GALERIA_COVER.$entrada_recuperada -> obtener_imagen();?>" class="imagen-3 d-none d-sm-block">
					</div>
					<div class="col-1"></div>
    ...
    <div class="col-12 row valign-wrapper">
    	...
    	<div class="col-md-10 row">
			<div class="input-field col-12">
				<textarea id="texto" name="texto" style="min-height: 20vh;max-height: 30vh;overflow-y: scroll;font-size: .9em;" class="materialize-textarea" data-length="3000" maxlength="3000"><?php echo $entrada_recuperada -> obtener_texto(); ?></textarea>
