...
include_once 'app/galeria/ValidadorEntrada.inc.php';
...
if (isset($_POST['guardar'])) {
	...
	$validador = new ValidadorEntradaGaleria($_POST['url'], $_POST['imagen'], $_POST['texto'], Conexion :: obtener_conexion());
	...
	if ($validador -> entrada_valida()) {
		if (ControlSesionAdmin :: sesion_iniciada()) {
			...
			$entrada = new EntradaGaleria('', $_SESSION['id_admin'], $validador -> obtener_url(), $validador -> obtener_imagen(),
				$validador -> obtener_texto(), '', $entrada_publica);//es muy importante que aqui el orden sea el mismo que el de la tabla de la base de datos
				
			$entrada_insertada = RepositorioEntradaGaleria :: insertar_entrada(Conexion :: obtener_conexion(), $entrada);
...
include_once 'scripts/galeria/barra-progreso.php';//script que sube las imagenes de las entradas
include_once 'scripts/galeria/barra-progreso-archivo-imagen.php';//script que sube las imagenes de las entradas
...
<div class="container-fluid">
	...
	<div class="row">  
		<div class="col-md-2 valign-wrapper">
			<?php include 'seccion/galeria/panel-ayuda-lateral.inc.php';?>
		</div>
		<div class="col-md-10 row">
			<div class="row valign-wrapper">
				...
				<div class="col-12 row">
					<div class="col-1"></div>
					<div class="col-10">
						<form method="post" action="<?php echo RUTA_NUEVA_ENTRADA_GALERIA ?>">
							<?php
								if (isset($_POST['guardar'])) {
									include_once 'seccion/galeria/form_nueva_entrada_validado.inc.php';
								} else {						
									include_once 'seccion/galeria/form_nueva_entrada_vacio.inc.php';
								}
							?>					
						</form>
					</div>
